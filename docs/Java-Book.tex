...
As \emph{arrays} são objetos que armazenam valores. Esse tipo de vetor tem um número fixo de posições que é determinado no momento de sua criação. Eles podem armazenar qualquer tipo de variável ou objeto. A estrutura de código para criar uma \emph{array} é apresentada abaixo.
...
\subsubsection{Acrescentando ou Mudando Valores}\label{acrescentando-ou-mudando-valores}}
...
\subsubsection{Acessando Valores}\label{acessando-valores}}
